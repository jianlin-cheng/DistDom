...
import pandas as pd
sequence_path = r'C:\Users\sajid\Downloads\CASP\CASP8\casp8.seq.txt'
domain_definition_csv_path = r'C:\Users\sajid\Downloads\CASP\CASP8\Domains Deffinition Summary - CASP8.csv'
save_path = r'C:\Users\sajid\Downloads\CASP\CASP8\casp8_dataset.csv'
...
print(column_list)
df.drop(df.loc[df['Classification']== 'MultiDom'].index, inplace=True)
...
for idx, contents in enumerate(parse):
    ...
    print(protein_name)
    print(len(sequence))
    domains = df.loc[df['Target'] == protein_name, 'Domain definition']
