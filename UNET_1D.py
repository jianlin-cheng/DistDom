...
class UNet_1d(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        ...
        self.inc = DoubleConv_1d(n_channels, 64)
        self.down1 = Down_1d(64, 128)
        self.down2 = Down_1d(128, 256)
        self.down3 = Down_1d(256, 512)
        factor = 2 if bilinear else 1
        self.down4 = Down_1d(512, 1024 // factor)
        self.up1 = Up_1d(1024, 512 // factor, bilinear)
        self.up2 = Up_1d(512, 256 // factor, bilinear)
        self.up3 = Up_1d(256, 128 // factor, bilinear)
        self.up4 = Up_1d(128, 64, bilinear)
        self.outc = OutConv_1d(64, n_classes)
